...
<nav>
  ...
  <ul class="nav-links" id="nav-links">
    <li><a href="HOME-MOVIL">Home</a></li>
    <li><a href="JUEGOS-MOVIL.php">Juegos</a></li>
    ...
    <?php endif; ?>
    <li><a href="index.php" title="Versión móvil">💻</a></li>
  </ul>
...
<header class="hero">
  ...
  <a href="JUEGOS-MOVIL.php"><button class="start-btn">¡Jugar ahora!</button></a>
</header>
